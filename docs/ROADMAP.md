...
| 4.13 | Web-Export-Deploy auf gleiche EC2 — Build via `scripts/godot-web-export.sh`, FastAPI mountet `/godot/` mit COOP/COEP-Headers fuer SharedArrayBuffer. EC2-Deploy-Step (Tarball-Inclusion) noch offen. | 0.5 Tag  | 🟡 lokal builbar, EC2-Deploy-Step offen                                                       |
